...
public class Stream_05_Test {
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum() {
        ...
        Logger.getAnonymousLogger().info("iterateSum => " + monitor -> iterateSum(NB), NB + " ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " + monitor(() -> parallelIterateSum(NB), NB) +  " ms");
    }
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum_vs_rangeSum_vs_rangeParallelSum() {
        ...
        Logger.getAnonymousLogger().info("rangeSum => " + monitor(() -> rangeSum(NB), NB) + " ms");
        Logger.getAnonymousLogger().info("rangeParallelSum => " + monitor(() -> rangeParallelSum(NB), NB) + " ms");
    }
